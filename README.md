...
```json
{
    ...
    "categories": {
        "category_1": [
            // Add unit IDs for category_1 here. Will need to make API calls to Comlink to get these using Postman or something similar.
        ],
        "category_2": [
            // Add unit IDs for category_2 here. Will need to make API calls to Comlink to get these using Postman or something similar.
        ]
    },
